import { defineComponent, computed, resolveComponent, openBlock, createBlock, withCtx, createElementVNode, normalizeClass, toDisplayString, createElementBlock, unref, createCommentVNode } from "@histoire/vendors/vue";
const _hoisted_1 = {
  key: 0,
      ...
      return openBlock(), createBlock(_component_VDropdown, {
        ...
        default: withCtx(({ shown }) => [
          createElementVNode("div", {
            ...
            __props.event.argument ? (openBlock(), createElementBlock("span", _hoisted_1, toDisplayString(unref(formattedArgument)), 1)) : createCommentVNode("", true)
          ], 2)
        ]),
        popper: withCtx(() => [
          createElementVNode("div", _hoisted_2, [
            createElementVNode("pre", _hoisted_3, toDisplayString(__props.event.argument), 1)
          ])
        ]),
        _: 1
      });
