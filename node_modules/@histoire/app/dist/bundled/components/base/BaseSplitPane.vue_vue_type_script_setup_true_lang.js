import { defineComponent, ref, watch, computed, onUnmounted, openBlock, createElementBlock, normalizeClass, createElementVNode, normalizeStyle, unref, renderSlot, withModifiers, pushScopeId, popScopeId } from "@histoire/vendors/vue";
const _withScopeId = (n) => (pushScopeId("data-v-ed925107"), n = n(), popScopeId(), n);
