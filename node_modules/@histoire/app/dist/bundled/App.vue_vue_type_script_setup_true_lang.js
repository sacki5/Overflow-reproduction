import { defineComponent, ref, computed, watch, onMounted, resolveComponent, openBlock, createElementBlock, Fragment, unref, createBlock, createCommentVNode, createElementVNode, normalizeStyle, createVNode, withCtx, Transition } from "@histoire/vendors/vue";
import { files, tree, onUpdate } from "virtual:$histoire-stories";
import "./components/tree/StoryList.js";
import BaseSplitPane from "./components/base/BaseSplitPane.js";
...
import Breadcrumb from "./components/app/Breadcrumb.js";
import "./components/search/SearchModal.js";
import "./components/app/InitialLoading.js";
import "./components/story/GenericMountStory.js";
import _sfc_main$1 from "./components/story/GenericMountStory.vue_vue_type_script_setup_true_lang.js";
import _sfc_main$2 from "./components/app/AppHeader.vue_vue_type_script_setup_true_lang.js";
import _sfc_main$3 from "./components/tree/StoryList.vue_vue_type_script_setup_true_lang.js";
import _sfc_main$4 from "./components/search/SearchModal.vue_vue_type_script_setup_true_lang.js";
import _sfc_main$5 from "./components/app/InitialLoading.vue_vue_type_script_setup_true_lang.js";
const _hoisted_1 = {
  key: 0,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(Transition, { name: "__histoire-fade" }, {
          default: withCtx(() => [
            loading.value ? (openBlock(), createBlock(_sfc_main$5, { key: 0 })) : createCommentVNode("", true)
          ]),
          _: 1
        })
      ], 64);
