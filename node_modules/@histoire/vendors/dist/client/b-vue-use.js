import { a as isVue3, i as isVue2, s as set$1, d as del } from './index.js';
import { R as shallowRef, P as watchEffect, S as readonly, C as unref, u as ref, B as watch, T as customRef, E as effectScope, Q as provide, z as inject, U as getCurrentScope, V as onScopeDispose, G as isRef, K as computed, L as reactive, J as toRefs$1, M as toRef, y as getCurrentInstance, W as onBeforeMount, b as nextTick, X as onBeforeUnmount, Y as onMounted, I as onUnmounted, H as isReactive, Z as onUpdated, D as markRaw, _ as onBeforeUpdate } from './vue.runtime.esm-bundler.js';
...
var __spreadValues$9$1 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$b$1.call(b, prop))
      __defNormalProp$9$1(a, prop, b[prop]);
  if (__getOwnPropSymbols$b$1)
    for (var prop of __getOwnPropSymbols$b$1(b)) {
      if (__propIsEnum$b$1.call(b, prop))
        __defNormalProp$9$1(a, prop, b[prop]);
    }
  return a;
};
var __spreadProps$6$1 = (a, b) => __defProps$6$1(a, __getOwnPropDescs$6$1(b));
...
var __defNormalProp$8$1 = (obj, key, value) => key in obj ? __defProp$8$1(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __spreadValues$8$1 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$a$1.call(b, prop))
      __defNormalProp$8$1(a, prop, b[prop]);
...
function makeDestructurable(obj, arr) {
  if (typeof Symbol !== "undefined") {
    const clone = __spreadValues$8$1({}, obj);
...
var __defNormalProp$6$1 = (obj, key, value) => key in obj ? __defProp$6$1(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __spreadValues$6$1 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$8$1.call(b, prop))
      __defNormalProp$6$1(a, prop, b[prop]);
  if (__getOwnPropSymbols$8$1)
    for (var prop of __getOwnPropSymbols$8$1(b)) {
      if (__propIsEnum$8$1.call(b, prop))
        __defNormalProp$6$1(a, prop, b[prop]);
    }
  return a;
};
...
var __spreadValues$5$1 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$7$1.call(b, prop))
      __defNormalProp$5$1(a, prop, b[prop]);
  if (__getOwnPropSymbols$7$1)
    for (var prop of __getOwnPropSymbols$7$1(b)) {
      if (__propIsEnum$7$1.call(b, prop))
        __defNormalProp$5$1(a, prop, b[prop]);
    }
  return a;
};
...
var __objRest$3 = (source, exclude) => {
  var target = {};
  for (var prop in source)
    if (__hasOwnProp$4$1.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && __getOwnPropSymbols$4$1)
    for (var prop of __getOwnPropSymbols$4$1(source)) {
      if (exclude.indexOf(prop) < 0 && __propIsEnum$4$1.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
function watchDebounced(source, cb, options = {}) {
  ...
  return watchWithFilter(source, cb, __spreadProps$4$1(__spreadValues$4$1({}, watchOptions), {
...
function watchThrottled(source, cb, options = {}) {
  const _a = options, {
    ...
    trailing = true,
    leading = true
  } = _a, watchOptions = __objRest$6(_a, [
    "throttle",
    "trailing",
    "leading"
  ]);
  return watchWithFilter(source, cb, __spreadProps$1$1(__spreadValues$1$1({}, watchOptions), {
...
function watchTriggerable(source, cb, options = {}) {
  ...
  return __spreadProps$9(__spreadValues$k({}, res), {
    trigger
  });
}
...
const getMapVue2Compat = () => {
  ...
  return {
    get: (key) => data[key],
    set: (key, value) => set$1(data, key, value),
