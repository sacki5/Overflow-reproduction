...
export declare function createMarkdownPlugins(ctx: Context): Promise<VitePlugin[]>;
export declare function createMarkdownFilesWatcher(ctx: Context): Promise<{
    stop: () => Promise<void>;
}>;
export declare type MarkdownFilesWatcher = ReturnType<typeof createMarkdownFilesWatcher>;
